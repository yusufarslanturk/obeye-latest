...
$buttons = [
	(new CButton('back', _('Go to dashboard')))
		->onClick('javascript: document.location = "skymon.php?action=dashboard.view"'
)];

echo '<body lang="'.CWebUser::getLang().'">';

(new CTag('main', true,
	new CWarning(_('Fatal error, please report to the SKYMON team'), $data['messages'], $buttons)
))->show();
