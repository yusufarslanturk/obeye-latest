...
class CControllerAcknowledgeCreate extends CController {
		...
		if (!$ret) {
			switch ($this->GetValidationError()) {
				case self::VALIDATION_ERROR:
					$response = new CControllerResponseRedirect('skymon.php?action=acknowledge.edit');
	...
	protected function doAction() {
		...
		if ($result) {
			$response = new CControllerResponseRedirect($this->getInput('backurl', 'skymon.php?action=problem.view'));
