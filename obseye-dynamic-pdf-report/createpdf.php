...
$stringData = "This is an automatically generated PDF file containing data gathered from OBSEYE Monitoring System\n";
fwrite($fh, $stringData);
$stringData = "#NP\n";
fwrite($fh, $stringData);
#$stringData = "1<Graphs>\n";
...
$pdf->addText(50,34,6,'Generated by OBSEYE Monitoring Remote Management  System Dynamic Report v1.1');
$pdf->restoreState();
$pdf->closeObject();
...
$pdf->ezText("$company_name OBSEYE Report",40,array('justification'=>'centre'));
