	...
	protected function getItems() {
		return [
			ITEM_TYPE_ZABBIX => [
				...
				[
					'key' => 'agent.version',
					'description' => _('Version of SKYMON agent. Returns string')
				],
				[
					'key' => 'kernel.maxfiles',
				...
				[
					...
					'description' => _('Returns a JSON object containing SKYMON server or proxy internal metrics.')
				],
				[
					'key' => 'zabbix.stats[<ip>,<port>,queue,<from>,<to>]',
					'description' => _('Number of items in the queue which are delayed in SKYMON server or proxy by "from" till "to" seconds, inclusive.')
				]
			],
			...
			ITEM_TYPE_AGGREGATE => [
				[
					...
					'description' => _('Aggregate checks do not require any agent running on a host being monitored. SKYMON server collects aggregate information by doing direct database queries. See SKYMON Manual.')
				]
			],
			ITEM_TYPE_SIMPLE => [
				[
			...
			ITEM_TYPE_INTERNAL => [
				[
					'key' => 'zabbix[boottime]',
					'description' => _('Startup time of SKYMON server, Unix timestamp.')
				],
				[
					'key' => 'zabbix[history]',
				...
				[
					...
					'description' => _('Returns a JSON array describing the host network interfaces configured in SKYMON. Can be used for LLD.')
				],
				[
				...
				[
					'key' => 'zabbix[items]',
					'description' => _('Number of items in SKYMON database.')
				],
				[
					'key' => 'zabbix[items_unsupported]',
					'description' => _('Number of unsupported items in SKYMON database.')
				],
				[
					'key' => 'zabbix[java,,<param>]',
					'description' => _('Returns information associated with SKYMON Java gateway. Valid params are: ping, version.')
				],
				[
					'key' => 'zabbix[process,<type>,<mode>,<state>]',
					'description' => _('Time a particular SKYMON process or a group of processes (identified by <type> and <mode>) spent in <state> in percentage.')
				],
				[
				...
				[
					...
					'description' => _('Required performance of the SKYMON server, in new values per second expected.')
				],
				[
					'key' => 'zabbix[stats,<ip>,<port>]',
					'description' => _('Returns a JSON object containing SKYMON server or proxy internal metrics.')
				...
				[
					'key' => 'zabbix[triggers]',
					'description' => _('Number of triggers in SKYMON database.')
				],
				[
					'key' => 'zabbix[uptime]',
					'description' => _('Uptime of SKYMON server process in seconds.')
				],
				[
