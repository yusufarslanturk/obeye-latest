...
class CBrandHelper {
	...
	public static function getHelpUrl() {
		return self::getValue('BRAND_HELP_URL', 'https://foneteye.foneyazilim.com/documentation/'.
	...
	public static function getFooterContent($with_version) {
		$footer = self::getValue(
			'BRAND_FOOTER',
			[
				$with_version ? 'SKYMON 4.5.24 ' : null,
				'&copy; '.ZABBIX_COPYRIGHT_FROM.'&ndash;'.ZABBIX_COPYRIGHT_TO.', ',
				(new CLink('Fonet Bilgi Teknolojileri A.S.', 'https://www.fonetyazilim.com/'))
