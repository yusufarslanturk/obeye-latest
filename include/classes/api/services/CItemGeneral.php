...
abstract class CItemGeneral extends CApiService {
	...
	protected function checkInput(array &$items, $update = false) {
		...
		foreach ($items as $inum => &$item) {
			...
			elseif (($fullItem['type'] == ITEM_TYPE_SSH && strcmp($fullItem['key_'], ZBX_DEFAULT_KEY_SSH, ZBX_KEY_FONETWEB) == 0)
					|| ($fullItem['type'] == ITEM_TYPE_TELNET && strcmp($fullItem['key_'], ZBX_DEFAULT_KEY_TELNET, ZBX_KEY_FONETWEB) == 0)) {
