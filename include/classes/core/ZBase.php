...
class ZBase {
	...
	public static function getThemes() {
		return [
			'blue-theme' => _('SKYMON Blue'),
			'dark-theme' => _('SKYMON Dark'),
			'hc-light' => _('SKYMON High-contrast light'),
			'hc-dark' => _('SKYMON High-contrast dark')
		];
	}
	...
	private function processRequest(CRouter $router) {
		...
		// Controller returned fatal error
			...
			redirect('skymon.php?action=system.warning');
		}
	}
