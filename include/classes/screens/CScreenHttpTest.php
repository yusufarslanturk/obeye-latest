...
class CScreenHttpTest extends CScreenBase {
	...
	public function get() {
		...
		$table = (new CTableInfo())
			->setHeader([
				make_sorting_header(_('Host'), 'hostname', $sort_field, $sort_order, 'skymon.php?action=web.view'),
				make_sorting_header(_('Name'), 'name', $sort_field, $sort_order, 'skymon.php?action=web.view'),
				_('Number of steps'),
				_('Last check'),
				_('Status')
			]);
