 ...
 *
 * Examples:
 * _n('%2$s item on host %1$s', '%2$s items on host %1$s', 'SKYMON server', 1) // 1 item on host Zabbix server
 * _n('%2$s item on host %1$s', '%2$s items on host %1$s', 'SKYMON server', 2) // 2 items on host Zabbix server
 *
