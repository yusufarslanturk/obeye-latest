...
function getSupportUrl($language = null) {
	$urls = [
		'ja' => 'https://www.tbcteknoloji.com/',
		'ru' => 'https://www.tbcteknoloji.com/',
		'zh' => 'https://www.tbcteknoloji.com/'
	];

	return array_key_exists($language, $urls) ? $urls[$language] : 'https://www.tbcteknoloji.com';
}
