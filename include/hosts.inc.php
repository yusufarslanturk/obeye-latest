...
function getHostInventories($orderedByTitle = false) {
	...
	$inventoryFields = [
		...
		63 => [
			...
			'title' => _('HbysServer_g2_04')
		],
		64 => [
			'nr' => 64,
			'db_field' => 'poc_2_name',
			'title' => _('HbysServer_g1_01')
		],
		65 => [
			'nr' => 65,
			'db_field' => 'poc_2_email',
			'title' => _('HbysServer_g1_02')
		],
		66 => [
			'nr' => 66,
			'db_field' => 'poc_2_phone_a',
			'title' => _('HbysServer_g1_03')
		],
		67 => [
			'nr' => 67,
			'db_field' => 'poc_2_phone_b',
			'title' => _('HbysServer_g1_04')
		],
		68 => [
			'nr' => 68,
			'db_field' => 'poc_2_cell',
			'title' => _('HbysServer_g2_01')
		],
		69 => [
			'nr' => 69,
			'db_field' => 'poc_2_screen',
			'title' => _('HbysServer_g2_02')
		],
		70 => [
			'nr' => 70,
			'db_field' => 'poc_2_notes',
			'title' => _('HbysServer_g2_03')
                ]
	];
 ...
 *               'templateid' => 10001,
 *               'name' => 'Template OS Linux by OBSEYE agent'
 *           ),
