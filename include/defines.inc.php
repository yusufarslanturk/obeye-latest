...
define('ZBX_KEY_FONETWEB',				'fonetweb.run[<unique short description>,<ip>,<port>,<encoding>]');
...
define('DASHBOARD_WIDGET_MAX_ROWS',	64);
...
define('ZBX_DEFAULT_URL', 'skymon.php?action=dashboard.view');
